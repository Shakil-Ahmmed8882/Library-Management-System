...
const getBookById = (bookId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.book.findUniqueOrThrow({ where: { bookId } });
    return result;
});
const updateBook = (bookId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const existingBook = yield prisma_1.default.book.findUnique({ where: { bookId } });
    if (!existingBook)
...
const deleteBook = (bookId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.book.delete({ where: { bookId } });
    return result;
});
